...
// 2. 인터페이스 주요맴버: 상수(public static final / 안쓰면 생략됨), 추상메소드
// 3. 추상메소드 구현할 클래스 필요 < 구현 객체 > , 클래스명 implements 인터페이스명, 인터페이스명

interface ExamInterFace { 
    int a = 10; // 상수
    public static final int b = 20;
    //  * 생성자가 없음. 즉 new가 없고 --> 인스턴스 불가능 , 목적 : 여러 인스턴스 호환/관리
...
public class Exam1 {
    public static void main(String[] args) {
        ...
        // [1] 인터페이스로 인스턴스 생성 불가능 -> 생성자가 없기 때문에
